...
import { IoSearch } from "react-icons/io5";
  ...
  function Search() {
    ...
    const categories = [
      ...
      "Architecte de l'intérieur",
      "Article Bébé et Maman",
      "Avionbateauxvéhiculemotocyclevélo",
      "Avocats",
      "Banque",
      "Base nautique",
      "Baseball",
      ...
      "Élevage les chevaux",
      "Élevage lapins",
      "Élevage volailles et oiseaux",
      "Épicerie",
      "Établissement privé",
      "Garderie scolaire", "crèche ","jardin d'enfants", "centre de soutien scolaire",  "école" , "lycée" , "faculté" , "Centre de formation",
      "Événementielle",
      "Expert",
      "Famille",
      "Fleuriste",
      ...
      "Lancer de poids",
      "Lavage de voiture et vidange",
      "Location de costumes et des robes des fêtes",
  ...
  const gouvernorats = [
    ...
    useEffect(() => {
      const closePopupsOnOutsideClick = (e) => {
        if (!e.target.closest('.popup') && !e.target.closest('.search-section-search')) {
          setShowRegionPopup(false);
          setShowCategoryPopup(false);
          setShowActivityPopup(false);
          setShowAdvancedSearchPopup(false);
